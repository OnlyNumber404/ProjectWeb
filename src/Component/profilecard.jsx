    ...
    >
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 object-cover rounded-[15px] will-change-transform transform-[translateZ(0)] border-2 border-white"
          style={{
            width: imageWidth,
            height: imageHeight
          }}
        ...
        {displayOverlayContent && overlayContent && (
          <motion.div className="absolute top-7 left-7 z-2 will-change-transform transform-[translateZ(30px)]">
            {overlayContent}
          </motion.div>
        )}
      </motion.div>
